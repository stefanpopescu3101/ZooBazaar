...
namespace Class_LibraryTests
{
    ...
    public class HabitatDbTests
    {
        ...
        {
            var habitat = new Habitat("Jungle#1", HabitatType.Arctic, 2, 5, FeedingTime.Evening);
            var habitatDb = new HabitatDb();
        ...
        {
            var habitat1 = new Habitat("Jungle#1", HabitatType.Jungle, 2, 5, FeedingTime.Morning);
            var habitat2 = new Habitat("Savannah#1", HabitatType.Savannah, 5, 1, FeedingTime.Morning);
            var habitat3 = new Habitat("Swamp#1", HabitatType.Swamp, 7, 2, FeedingTime.Morning);
        ...
        public void UpdateResponsibleEmployee_UpdateResponsibleEmployeeWithAValidEmployee_ShouldReturnTrue()
        {
            ...
            var newEmployee = new Employee(1002, "Sue", "TestUser2", "22345678", "sue@test.test", DateTime.Parse("01-03-2022").ToString(), DateTime.Parse("01-03-2023").ToString(),
                DateTime.Now, "permanent", 20, "Streetname", "test", 2, "employee", "test1", "password1");
            var habitat = new Habitat("Arctic#2", HabitatType.Arctic, 10, null, oldEmployee.Id, 7, FeedingTime.Morning);
            var habitatDb = new HabitatDb();
        ...
        public void UpdateHabitat_UpdateHabitatWithValidData_ShouldReturnTrue()
        {
            ...
            var oldHabitat = new Habitat(888,"Arctic#2", HabitatType.Arctic, 10, null, 911, 7, FeedingTime.Morning);
            var newHabitat = new Habitat(888, "Savannah#8", HabitatType.Savannah, 18, null, 900, 4, FeedingTime.Morning);
            var habitatDb = new HabitatDb();
